...
<body>
    ...
    echo "<h1>BIO DATA</h1>";
    echo "<table width='60%'>";
    echo "<tr><td class='atas' width='30%'>Nama :</td><td width='30%'><input type='text' name='name' value='Okbye Tribudiawan'></td></tr>";
    echo "<tr><td class='atas'>NIM :</td><td><input type='text' name='name' value='2170234022'></td></tr>";
    ...
    echo "<tr><td class='atas'>Foto :</td><td><img src='okby.png' width='200px'></img></td></tr>";
